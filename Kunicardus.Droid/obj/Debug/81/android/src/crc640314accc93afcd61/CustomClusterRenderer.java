...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Kunicardus.Droid.CustomClusterRenderer, Unicard.Droid", CustomClusterRenderer.class, __md_methods);
	}
	...
	public CustomClusterRenderer (android.content.Context p0, com.google.android.gms.maps.GoogleMap p1, com.google.maps.android.clustering.ClusterManager p2)
	{
		...
		if (getClass () == CustomClusterRenderer.class)
			mono.android.TypeManager.Activate ("Kunicardus.Droid.CustomClusterRenderer, Unicard.Droid", "Android.Content.Context, Mono.Android:Android.Gms.Maps.GoogleMap, Xamarin.GooglePlayServices.Maps:Com.Google.Maps.Android.Clustering.ClusterManager, GoogleMapsUtilityBinding", this, new java.lang.Object[] { p0, p1, p2 });
	}
