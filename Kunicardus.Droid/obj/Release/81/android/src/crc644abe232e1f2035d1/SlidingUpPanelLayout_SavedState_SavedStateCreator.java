...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Kunikardus.Droid.Plugins.SlidingUpPanel.SlidingUpPanelLayout+SavedState+SavedStateCreator, Unicard.Droid", SlidingUpPanelLayout_SavedState_SavedStateCreator.class, __md_methods);
	}


	public SlidingUpPanelLayout_SavedState_SavedStateCreator ()
	{
		super ();
		if (getClass () == SlidingUpPanelLayout_SavedState_SavedStateCreator.class)
			mono.android.TypeManager.Activate ("Kunikardus.Droid.Plugins.SlidingUpPanel.SlidingUpPanelLayout+SavedState+SavedStateCreator, Unicard.Droid", "", this, new java.lang.Object[] {  });
	}
